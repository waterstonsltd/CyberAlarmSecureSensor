...
| `Failed to load TLS server certificate` | Wrong password or corrupt file | Verify `TlsCertificatePassword` matches the PKCS#12 password; regenerate the file if needed |
