...
internal sealed class SourceGrouperBuilder
{
    ...
    public SourceGrouper Build() => new(FileManager, _relayOptions, _pipelineOptions, new UploadMetrics(new TestMeterFactory(), Options.Create(new RelayOptions())), Logger);
}
