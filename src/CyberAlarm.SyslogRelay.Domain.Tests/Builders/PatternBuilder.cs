...
internal sealed class PatternBuilder
{
    ...
    private string[] _ignoreIfContaining = [];

    public Pattern Build() => new(_name, _parser, _priority, _rules, _ignoreIfContaining);

    public PatternBuilder WithIgnoreIfContaining(params string[] values)
    {
        _ignoreIfContaining = values;
        return this;
    }
