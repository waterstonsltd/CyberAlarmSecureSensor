    ...
    public static TheoryData<string, ParseResult> TestLogs =>
        new()
        {
            ...
            },
            {
                ...
                new("192.0.2.1", "10.0.1.50", 1234, 4321, EventProtocol.Tcp, EventAction.Close)
            },
            {
            ...
            },
            {
                ...
                new("192.0.2.1", "10.0.1.50", 1234, 4321, EventProtocol.Udp, EventAction.Timeout, TimeSpan.Zero, 173)
            },
            {
            ...
            },
            {
                ...
                new("3.235.189.123", "172.16.255.212", 443, 52870, EventProtocol.Tcp, EventAction.Close, TimeSpan.Zero, 10058)
            },
            {
            ...
            },
            {
                ...
                new("203.0.113.10", "10.0.1.50", 443, 41234, EventProtocol.Tcp, EventAction.Timeout, TimeSpan.FromMinutes(5), 4096)
            },
            {
