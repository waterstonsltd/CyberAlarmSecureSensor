...
internal static class WindowsHost
{
    ...
    private static void ConfigureServiceRecovery()
    {
        ...
        // Clear failureflag so recovery only fires on crashes, not clean exits (e.g. graceful update shutdown).
        RunScCommand($"failureflag \"{ServiceName}\" 0", ignoreExitCode: true);
    }
