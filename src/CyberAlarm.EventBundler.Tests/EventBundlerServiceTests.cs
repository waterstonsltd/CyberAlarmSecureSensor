...
public sealed class EventBundlerServiceTests : IDisposable
{
    ...
    Platform _platform = new Platform("Test", "1.0", "x64", null);
    ...
    EventsMetaData _eventsMetaData;
    EventBundle _sampleEvent;

    public EventBundlerServiceTests()
    {
        _eventsMetaData = new("TestIngestion", "TestSource", 10, 1, 1, 1);
    ...
    public async Task BundleAddsMetaDataToEventBundleCorrectly()
    {
        ...
        Assert.Equal(_eventsMetaData, result.Document.EventsMetaData);
