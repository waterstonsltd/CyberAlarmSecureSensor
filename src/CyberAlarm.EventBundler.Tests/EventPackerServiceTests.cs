...
public sealed class EventPackerServiceTests : IDisposable
{
    ...
    public async Task CompressAndEncryptWithValidDataReturnsEncryptionModel()
    {
        ...
        // Act
        var result = await service.CompressAndEncrypt(_serverPublicKey, _outputStream, testData, _compressionAlgorithm, _symmetricEncryptionAlgorithm, _asymmetricEncryptionAlgorithm, CancellationToken.None);
    ...
    public async Task CompressAndEncryptWithNullCompressionAlgorithmThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentNullException>(() =>
            service.CompressAndEncrypt(_serverPublicKey, _outputStream, testData, null!, _symmetricEncryptionAlgorithm, _asymmetricEncryptionAlgorithm, CancellationToken.None));
    }
    ...
    public async Task CompressAndEncryptWithEmptySymmetricAlgorithmThrowsArgumentException()
    {
        ...
        await Assert.ThrowsAsync<ArgumentException>(() =>
            service.CompressAndEncrypt(_serverPublicKey, _outputStream, testData, _compressionAlgorithm, string.Empty, _asymmetricEncryptionAlgorithm, CancellationToken.None));
    }
    ...
    public async Task CompressAndEncryptWithEmptyAsymmetricAlgorithmThrowsArgumentException()
    {
        ...
        // Act & Assert
        await Assert.ThrowsAsync<ArgumentException>(() =>
            service.CompressAndEncrypt(_serverPublicKey, _outputStream, testData, _compressionAlgorithm, _symmetricEncryptionAlgorithm, string.Empty, CancellationToken.None));
    }
    ...
    public async Task CompressAndEncryptCallsPluginFactoriesWithCorrectAlgorithms()
    {
        ...
        // Act
        await service.CompressAndEncrypt(_serverPublicKey, _outputStream, testData, _compressionAlgorithm, _symmetricEncryptionAlgorithm, _asymmetricEncryptionAlgorithm, CancellationToken.None);
    ...
    public async Task CompressAndEncryptCallsSymmetricEncryptWithCorrectDataAndReturnsEncryptedData()
    {
        ...
        // Assert
        await mockSymmetricEncryptor.Received(1).EncryptStreamAsync(Arg.Any<Stream>(), _outputStream, expectedSessionKey, Arg.Any<CancellationToken>());
    ...
    public async Task CompressAndEncryptCallsCompressorWithCorrectData()
    {
        ...
        // Assert
        await mockCompressor.Received(1).Compress(testData, Arg.Any<Stream>());
    }
