...
public interface IEventPackerService
{
    ...
    /// </returns>
    Task<Encryption> CompressAndEncrypt(byte[] serverPublicKey, Stream outputBundle, Stream data, string compressionAlgorithm, string symmetricEncryptionAlgorithm, string asymmetricEncryptionAlgorithm, CancellationToken cancellationToken);
