...
public sealed class PeriodicOperation(
    IApplicationManager applicationManager,
    ILogger<PeriodicOperation> logger) : IPeriodicOperation
{
    ...
    public void Start(PeriodicOperationSettings settings, CancellationToken cancellationToken)
    {
        ...
        _shutdownOnError = settings.ShutdownOnError;
    ...
    private async Task RunTimerAsync(CancellationToken cancellationToken)
    {
        ...
        {
            _logger.LogError(ex, "Error when running periodic {Operation}.", _operationDescription);
