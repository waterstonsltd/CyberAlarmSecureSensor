...
public sealed class SecureFtpClient : ISecureFtpClient
{
    ...
    public SecureFtpClient(string hostName, string userName, PrivateKeyFile privateKeyFile, IReadOnlyList<string> hostFingerprints)
    {
        ...
        {
            e.CanTrust = e.FingerPrintSHA256.MatchesAnyHostFingerprint(hostFingerprints);
        };
    }
