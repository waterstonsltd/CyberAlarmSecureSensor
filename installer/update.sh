...
#   6. Verify the signature of every image referenced in the compose file with Cosign if available
#   7. Pull the latest container image and restart the service only if the image changed
...
# ---------------------------------------------------------------------------
# Step 4: Verify image signature with Cosign (if available)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Step 5: Pull latest image and restart if updated
# ---------------------------------------------------------------------------
cd "$INSTALL_DIR"
