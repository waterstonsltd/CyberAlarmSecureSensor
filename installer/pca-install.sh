...
UPDATE_SCRIPT_SHA256="2c7b2066099da76fb2fe63f06b2b574b4de127cb37ee525ba0554a59759c8ee4"
...
install_cron_job() {
    ...
    local cron_cmd="$UPDATE_SCRIPT --install-dir '$INSTALL_DIR' --compose-file '$COMPOSE_FILE' --compose-url '$COMPOSE_URL'"
...
display_summary() {
    ...
    if [[ "$has_autoupdate" == "true" ]]; then
        echo "  Manual update:   $UPDATE_SCRIPT --install-dir '$INSTALL_DIR' --compose-file '$COMPOSE_FILE' --compose-url '$COMPOSE_URL'"
    fi
    echo ""
