...
> ```
> ddb05959dc9e276e25ce63151a9470354252ed85804a92bce5bf69a2af5cbea7
> ```
...
curl -fsSL https://raw.githubusercontent.com/waterstonsltd/CyberAlarmSecureSensor/refs/heads/main/installer/pca-install.sh -o pca-install.sh \
  && echo "ddb05959dc9e276e25ce63151a9470354252ed85804a92bce5bf69a2af5cbea7  pca-install.sh" | sha256sum --check \
...
```
fef7142ffadfdf6d8d8debe50b5dfca834cec1c4cc2fcd6a3513df7083aa1c60
```
...
Compare the output against `fef7142ffadfdf6d8d8debe50b5dfca834cec1c4cc2fcd6a3513df7083aa1c60` (or the current hash shown on the [CyberAlarm portal](https://member.cyberalarm.police.uk)).
