...
> ```
> 9f2d7aef9f5028ef119dde6cf374f19f83d241728c5d1e7490a0a12cd4070930
> ```
...
curl -fsSL https://raw.githubusercontent.com/waterstonsltd/CyberAlarmSecureSensor/refs/heads/main/installer/pca-install.sh -o pca-install.sh \
  && echo "9f2d7aef9f5028ef119dde6cf374f19f83d241728c5d1e7490a0a12cd4070930  pca-install.sh" | sha256sum --check \
...
> ```
> a3a817c1f70b348a90ddedf3ead01decf7163de1f7e6a52e58f1d7361a1c8407
> ```
> Cross-reference this against the hash shown on the [CyberAlarm portal](https://member.cyberalarm.police.uk) before running.
...
if ((Get-FileHash .\Install-CyberAlarmSecureSensor.ps1 -Algorithm SHA256).Hash.ToLowerInvariant() -ne "a3a817c1f70b348a90ddedf3ead01decf7163de1f7e6a52e58f1d7361a1c8407") {
