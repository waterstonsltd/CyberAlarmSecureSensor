...
> ```
> c983c6035f69af48b2f444056c5293fbce78477ca6ca3412dc317a94159b93a7
> ```
...
curl -fsSL https://raw.githubusercontent.com/waterstonsltd/CyberAlarmSecureSensor/refs/heads/main/installer/pca-install.sh -o pca-install.sh \
  && echo "c983c6035f69af48b2f444056c5293fbce78477ca6ca3412dc317a94159b93a7  pca-install.sh" | sha256sum --check \
...
| `TlsPort` | `6514` | TCP port for the TLS listener. |
...
The relay can be deployed on a cloud VM or a managed container service. See [docs/cloud-hosting.md](docs/cloud-hosting.md) for deployment patterns covering site-to-site VPN, WireGuard, TLS syslog, Azure Container Instances, AWS Fargate, and IP access restrictions.
